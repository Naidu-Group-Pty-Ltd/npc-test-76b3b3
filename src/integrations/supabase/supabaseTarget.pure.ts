 ...
 * project.)
 */
export const FALLBACK_URL = 'https://umrtusxohxjxzodxorim.supabase.co';
export const FALLBACK_ANON_KEY =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVtcnR1c3hvaHhqeHpvZHhvcmltIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODgyNDM5MDgsImV4cCI6MjEwMzgxOTkwOH0.cUjoeKWDj-7fD5GGipp2R7peh_8YonwDzgi96F6PEHg';
