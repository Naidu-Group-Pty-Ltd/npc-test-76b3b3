                            ...
                            <p
                              className={cn(
                                ...
                                conv.unread_count > 0
                                  ...
                                  : "text-muted-foreground/85 dark:text-muted-foreground/85 group-hover:text-foreground/90",
                              )}
                              title={
